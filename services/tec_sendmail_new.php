...
// *************** THIS CASE IS NON-FUNCTIONAL - SEE TEC_SENDMAIL.PHP
            ...
            case 'prayer_request_church':
                ...
                $mailmessage .= "<p>Prayer Request ID = <strong>" . $prayerID . "</strong>.</p>";
            ...
            case 'prayer_request_elder':
                ...
                $mailmessage .= "<p><strong>" . $prayer_name . "</strong> has requested you to pray for them.</p>";
                $mailmessage .= "<p>Their prayer request is as follows:</p>";
                $mailmessage .= "<p><strong>Prayer Title: </strong> " . $prayer_title . "</p>";
                $mailmessage .= "<p><strong>Prayer Text: </strong> " . $prayer_text . "<br /><br /></p>";
                ...
                $mailmessage .= "<p><a href=http://" . $maillink . ">" . $customer . "</a></p>";
                $mailmessage .= "<p>For reference, the prayer Request ID is <strong>" . $prayerID . "</strong>.</p>";
                $mailmessage .= "<p><br />Thank you!<br />The OurFamilyConnections team.</p>";            
                $mailmessage .= "</body></html>";
