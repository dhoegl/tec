...
// *************** THIS CASE IS NON-FUNCTIONAL - SEE TEC_SENDMAIL.PHP
            ...
            case 'prayer_request_church':
                ...
                $mailmessage .= "<p>Prayer Request ID = <strong>" . $prayer_ID . "</strong>.</p>";
            ...
            case 'prayer_request_elder':
                ...
                $mailmessage .= "<p><li>Login to our site using your credentials, and select the requestor's profile from the Directory.</p>";
                $mailmessage .= "<p><a href=http://" . $maillink . ">" . $customer . "</a></p>";
                $mailmessage .= "<p>For reference, the prayer Request ID is <strong>" . $prayer_ID . "</strong>.</p>";
                $mailmessage .= "<p><br />Thank you!<br />The OurFamilyConnections team.</p>";            
                $mailmessage .= "</body></html>";
