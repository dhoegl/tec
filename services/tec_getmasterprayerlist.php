...
/*Query master prayer listing: visible = 3 (all) and status = 1 */
		...
		while($masterrow = $masterprayerresult->fetch_assoc()) {
				...
				$masterfirstname = $masterrow['firstname'];
				$masterlastname = $masterrow['lastname'];
