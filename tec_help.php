                ...
                <div class="card bg-light border-primary p-3 mt-2 my-2">
                    <div class="card-body">
                        ...
                        <div class="faq_container">
				            <div class="faq">
					            <div class="faq_question note note-warning">Where do I go to download a printable directory?</div>
				            ...
				            <div class="faq">
					            <div class="faq_question note note-warning">Is there a way to print out the calendar?</div>
						        <div class="faq_answer_container">
				            ...
				            <div class="faq">
					            <div class="faq_question note note-warning">Who do I contact if I have questions or need more details on how to use this site?</div>
						        <div class="faq_answer_container">
